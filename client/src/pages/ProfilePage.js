    ...
    return (
      <div className="min-h-screen   flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/dashboard" className="text-slate-400 hover:text-slate-800">
            Back to Dashboard
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50  py-8">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="  rounded-lg bg-slate-200 shadow-md p-6 mb-8">
                ...
                <form onSubmit={handleEditSubmit} className="space-y-4">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <button
                      ...
                      className="px-4 py-2 border border-purple-300 text-gray-700 rounded-md hover:bg-slate-100 transition duration-300"
                    >
                      Cancel
                    </button>
                  </div>
          ...
          {userPosts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {userPosts.map((post) => (
                <div
                  key={post._id}
                  className="border bg-slate-100 rounded-lg p-4 hover:shadow-md transition duration-300"
                >
                  {post.featuredImage && (
                    <div className="h-52 overflow-hidden rounded-md mb-4">
                      <img
